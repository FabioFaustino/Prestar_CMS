...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Pro favor, edite este campo.",
		...
		digits: "Introduza apenas números.",
		equalTo: "Introduza novamente o mesmo valor.",
		maxlength: $.validator.format( "Introza menos de {0} caracteres." ),
		minlength: $.validator.format( "Introduza pelo menos {0} caracteres." ),
		rangelength: $.validator.format( "Introduza entre {0} a {1} caracteres." ),
		...
		step: $.validator.format( "Intoruza um múltiplo de {0}." )
	},
